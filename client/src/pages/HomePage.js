...
const HomePage = () => {
  ...
  const [frequency, setFrequency] = useState("21000");
  ...
  return (
    <Layout>
      ...
      <div className="filters">
        <div>
          ...
          <Select value={frequency} onChange={(values) => setFrequency(values)}>
            <Select.Option value="7300">Upto 20 years</Select.Option>
            <Select.Option value="9125">Upto 25 year</Select.Option>
            <Select.Option value="21000">ALL</Select.Option>
        ...
        <div className="filter-tab ">
          ...
          <Select value={type} onChange={(values) => setType(values)}>
            ...
            <Select.Option value="Nadeem Tarin">NT</Select.Option>
            <Select.Option value="Sulaimaan Hall">SH</Select.Option>
      ...
      >
        ...
        >
          <Form.Item label="Semester" name="amount">
            <Input type="text" required />
          </Form.Item>
          <Form.Item label="Hall" name="type">
            <Select>
            <Select.Option value="Nadeem Tarin">NT</Select.Option>
            <Select.Option value="Sulaimaan Hall">SH</Select.Option>
          ...
          <Form.Item label="Branch" name="category">
            <Select>
              ...
              <Select.Option value="Petrochemical">Petrochemical</Select.Option>
          ...
          <Form.Item label="Faculty No." name="refrence">
            <Input type="text" required />
          </Form.Item>
